...
original = cv2.imread('fotosCasa11.jpg')            # read next frame
...
#print red
red=multiplicador*red
blue = blue
print "red channel"
#Perform NDVI calculation
numerator = 1*cv2.subtract(blue,red)
#numerator = fIR-fBLUE
...
img_map =  cv2.applyColorMap (fraction, cv2.COLORMAP_HSV)
#	#cv2.imshow("COLORMAP",img_map)
#	# write to disc
print "writing Images",
cv2.imshow('NDVIcolormap',img_map)
cv2.imwrite("NDVIcolormap.jpg",img_map)
#division=ndvi
#print division
