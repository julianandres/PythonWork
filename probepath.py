...
#cv2.imshow("Blue",b)	
cv2.imwrite('/home/julian/PythonWork/Bandas/restaPrueba/'+nombre+'Red.jpg',RED)
#cv2.imshow("Green",g)
cv2.imwrite("/home/julian/PythonWork/Bandas/restaPrueba/"+nombre+"Green.jpg",g)
print "hola"
cv2.imwrite('/home/julian/PythonWork/Bandas/restaPrueba/'+nombre2+'IR.jpg',IR2)
#cv2.imshow("Blue",b)	
cv2.imwrite('/home/julian/PythonWork/Bandas/restaPrueba/'+nombre2+'Red.jpg',RED2)
#cv2.imshow("Green",g)
cv2.imwrite("/home/julian/PythonWork/Bandas/restaPrueba/"+nombre2+"Green.jpg",g2)
